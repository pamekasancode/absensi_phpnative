...
$query = mysqli_query($conn, "SELECT * FROM absensi WHERE tanggal = '$tgl' ");
  	...
  	<div class="header">
  		<div class="container">
  			<form method="post">
	  			...
	  			<a href="excel.php" class="excel">Export Excel</a>
	  		</form> 
  		</div>
  	</div>
  	<div class="main">
  		<div class="container">
  			<div class="row">
  				<div class="col">
  					<p>Absensi Tanggal: <?= $tgl; ?></p>
  				</div>
  				<div class="col">
  					<p>Jumlah Absensi: <?= $jumlah_absensi; ?></p>
  				</div>
  			</div>
